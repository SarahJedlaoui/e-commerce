        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @else
                    ...
                    <a href="/index" class="btn btn-dark">Continue Shopping</a>
                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <p>
                                ...
                                <b>Price: </b>{{ $item->price }} DT<br>
                                <b>Sub Total: </b>{{ \Cart::get($item->id)->getPriceSum() }} DT<br>
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><b>Total: </b>{{ \Cart::getTotal() }} DT</li>
                        </ul>
                    </div>
